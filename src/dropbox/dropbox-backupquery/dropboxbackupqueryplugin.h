...
class Q_DECL_EXPORT DropboxBackupQueryPlugin : public SocialdButeoPlugin
{
    Q_OBJECT
...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.sailfishos.plugins.sync.DropboxBackupQueryPluginLoader")
