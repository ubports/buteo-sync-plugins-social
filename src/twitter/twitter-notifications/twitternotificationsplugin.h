...
class Q_DECL_EXPORT TwitterNotificationsPlugin : public SocialdButeoPlugin
{
    Q_OBJECT
...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.sailfishos.plugins.sync.TwitterNotificationsPluginLoader")
